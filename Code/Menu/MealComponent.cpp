...
/// @brief a function to set the cost of the meal component if you wanted to change it.
...
/// @param type what type of component it is.(to know which chef will prepare it)
