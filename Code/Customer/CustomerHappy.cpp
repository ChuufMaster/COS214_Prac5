 ...
 *
 * @details This function decrements the customers happiness (once per round) and if the customerHappiness
 * is less or equal to zero, sets the Customers _happyState to CustomerUnhappy()
 * 
 * @param c a pointer to the customer that called the function so that it's state can be updated
 *
 * @return A boolean that represents the Customers happiness
 */ 
